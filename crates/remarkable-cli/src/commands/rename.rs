...
fn parent_path<'a>(
    ...
    match entry.parent {
        remarkable_metadata::metadata::Parent::Root => None,
        remarkable_metadata::metadata::Parent::Trash => Some("/trash"),
        remarkable_metadata::metadata::Parent::Folder(uuid) => tree.display_path(&uuid),
    }
}
